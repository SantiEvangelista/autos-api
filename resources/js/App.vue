    ...
    <div class="relative z-10 max-w-5xl mx-auto px-5 sm:px-6 lg:px-12">
      ...
      <nav class="flex items-center justify-between py-4 sm:py-6">
        ...
        <div class="flex items-center gap-4 sm:gap-5">
          ...
          <a href="https://github.com/SantiEvangelista/arg-autos-api" target="_blank" rel="noopener" class="flex items-center gap-1.5 font-mono text-[11px] sm:text-xs text-cream/40 active:text-gold hover:text-gold transition-colors duration-300">
            ...
            <span>GitHub</span>
            <span v-if="githubStars !== null" class="bg-cream/10 px-1.5 py-0.5 rounded text-[10px] sm:text-[11px]">{{ githubStars }}</span>
          </a>
        </div>
      </nav>
...
fetch('https://api.github.com/repos/SantiEvangelista/arg-autos-api')
